...
CFLAGS = -Iinclude -I/usr/local/include -I$(HOME)/.local/include -std=c++20 -Wall -Wextra -O2 $(SANITIZER_FLAGS)
LDFLAGS = -L/usr/local/lib -L$(HOME)/.local/lib $(SANITIZER_FLAGS)
